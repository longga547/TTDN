...
const Footer = () => {
  return (
    <footer className="mt-4">
      ...
      <div className="bg-[#002935] text-white footer ">
        <div className="lg:flex md:px-[100px] px-10 pt-[100px]">
          {/* 4col */}
          <div className="md:flex mb-10 w-full justify-between gap-[120px] lg:w-1/2 ">
            {/* Cột 1 */}
            <div className="1col w-1/2 mb-10 ">
              ...
              <p className="mt-2">
                Get a full control of debts in the digital world simply labore
                et dolore magna.
              </p>
              <div className="my-8 text-2xl font-medium">Follow us on</div>
          ...
          {/* 4col */}
          <div className="md:flex  w-full justify-between gap-[120px] lg:w-1/2 ">
            {/* Cột 3 */}
            <div className="w-1/2 mb-10">
              <h3 className="text-2xl font-bold">Get In Touch</h3>
              <div className="mt-8 text-lg space-y-3">
                <div>
                  <p className="mt-2">Address</p>
                  <p>244, First Floor, Los Angeles</p>
                </div>
                <div>
        ...
        <div className="mt-10 lg:flex md:px-[100px] px-10 pt-6 pb-4  justify-between border-t border-gray-500 border-opacity-50  ">
          {/* 1 */}
          <div className="text-lg sm:flex justify-center ">
            <p className="flex justify-center">
              © 2023 - 2025 | All rights reserved by
            </p>
            <p className="text-blue-700 flex justify-center mx-2">
              {" "}
              website stock
            </p>
          </div>
