...
const TeamDetail = () => {
  ...
  const anh1 = 'https://template-intern.l5elb4sxvvqkvl.flashvps.xyz/Edu/education-learning-lms-html-template-estudy-2023-12-07-15-45-43-utc/estudy/assets/images/team/team1.png';
  const anh2 = 'https://template-intern.l5elb4sxvvqkvl.flashvps.xyz/Edu/education-learning-lms-html-template-estudy-2023-12-07-15-45-43-utc/estudy/assets/images/team/team2.png';
  const anh3 = 'https://template-intern.l5elb4sxvvqkvl.flashvps.xyz/Edu/education-learning-lms-html-template-estudy-2023-12-07-15-45-43-utc/estudy/assets/images/team/team3.png';
  const anh4 = 'https://template-intern.l5elb4sxvvqkvl.flashvps.xyz/Edu/education-learning-lms-html-template-estudy-2023-12-07-15-45-43-utc/estudy/assets/images/team/team4.png';
  const onggia ='https://template-intern.l5elb4sxvvqkvl.flashvps.xyz/Edu/education-learning-lms-html-template-estudy-2023-12-07-15-45-43-utc/estudy/assets/images/team/team-details-thumb.jpg';
  return (
        ...
        <div className="relative flex flex-col bg-white shadow-lg rounded-lg overflow-hidden">
          <div className="flex flex-col lg:flex-row w-full">
            <div className="mt-16 mx-4 lg:mx-12 w-full lg:w-1/2">
              <Image
                alt="Portrait of a man in a suit and tie"  width={1920} height={400} 
              ...
              <tbody>
                ...
                <div className="bg-white w-[38px] h-[38px] rounded-full border-2 border-[#747474] transition-colors duration-300 hover:text-white hover:bg-blue-500 flex items-center justify-center">
                  ...
                  <div className="bg-white w-[38px] h-[38px] rounded-full border-2 border-[#747474] transition-colors duration-300 hover:text-white hover:bg-red-500 flex items-center justify-center">
                    <span>
                      <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24">
                        <path fill="currentColor" fillRule="evenodd" d="M6.989 4.89a64 64 0 0 1 10.022 0l2.24.176a2.725 2.725 0 0 1 2.476 2.268c.517 3.09.517 6.243 0 9.332a2.725 2.725 0 0 1-2.475 2.268l-2.24.175a64 64 0 0 1-10.023 0l-2.24-.175a2.725 2.725 0 0 1-2.476-2.268a28.3 28.3 0 0 1 0-9.332a2.725 2.725 0 0 1 2.475-2.268zM10 14.47V9.53a.3.3 0 0 1 .454-.257l4.117 2.47a.3.3 0 0 1 0 .514l-4.117 2.47A.3.3 0 0 1 10 14.47"/>
                      </svg>
                    </span>
                  </div>
                  </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="bg-white rounded-lg shadow-lg overflow-hidden group">
              <Image
                ...
                src={anh1} width={2000} height={1080}
              />
              <div className="p-6">
            ...
            <Image
                alt="Portrait of Earle Goodman"
                className="w-full h-64 object-cover transition-transform duration-300 group-hover:scale-110"
                src={anh2} width={1920} height={400}
              />
              <div className="p-6">
                <h2 className="text-xl font-bold text-center text-black transition-colors duration-300 group-hover:text-blue-500">
                  Sarah Taylor
            ...
            <Image
                alt="Portrait of Earle Goodman"
                className="w-full h-64 object-cover transition-transform duration-300 group-hover:scale-110"
                src={anh3} width={1920} height={400}
              />
              <div className="p-6">
                <h2 className="text-xl font-bold text-center text-black transition-colors duration-300 group-hover:text-blue-500">
                  Hunter Hunter
            ...
            <Image
                alt="Portrait of Earle Goodman"
                className="w-full h-64 object-cover transition-transform duration-300 group-hover:scale-110"
                src={anh4} width={2000} height={600}
              />
              <div className="p-6">
                <h2 className="text-xl font-bold text-center text-black transition-colors duration-300 group-hover:text-blue-500">
                  Norris Weeks
